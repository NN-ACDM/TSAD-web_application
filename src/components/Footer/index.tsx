...
const Footer = () => {
  return (
    <footer
      className="flex flex-col items-center wow fadeInUp relative z-10 pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold ">Our Products</h4>
              <ul>
                <li>
                  <Link
                    href="#"
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold ">Useful Links</h4>
              <ul>
                <li>
                  <Link
                    href="#"
      ...
      <div className="flex justify-center w-full mt-6 border-t border-[#8890A4] border-opacity-40 lg:mt-[60px]">
        <p className="font-size-2 text-base text-gray-4">
          TSAD Official Website Build Version {} {"("}Latest Update: {")"}
        </p>
      </div>
